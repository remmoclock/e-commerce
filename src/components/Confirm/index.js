...
import { resetCart } from "../../app/redux/actions"
import "../Confirm/confirmStyles.css"
  ...
  return (
    <Fragment>
      <div className="jumbotron text-center">
        <h1 className="display-3">Merci pour votre achat!</h1>
        <hr />

        <p className="lead">
          <strong>Votre commande est en cours de livraison</strong>
          <br /> <br />
          <Link
        ...
        {userProfile.address && (
          <ul className="address">
            <li>{userProfile.lastName.toUpperCase()}</li>
